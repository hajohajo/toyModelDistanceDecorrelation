#This is completely from authors of https://arxiv.org/abs/2001.05310 and their repository at https://github.com/gkasieczka/DisCo/
...
def distance_corr(var_1, var_2, normedweight, power=1):
    ...
    if power == 1:
        ...
        dCorr = (tf.reduce_mean(ABavg * normedweight) / tf.math.sqrt(
            tf.reduce_mean(AAavg * normedweight) * tf.reduce_mean(BBavg * normedweight))) ** power
